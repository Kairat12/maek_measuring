...
class MainSklad(models.Model):
    ...
    quantity = models.DecimalField(null=True,blank=True, verbose_name="Количество")
    price = models.DecimalField(null=True,blank=True, verbose_name="Цена")
    sum = models.DecimalField(null=True,blank=True, verbose_name="Сумма")
