...
class MainSklad(models.Model):
    ...
    quantity = models.DecimalField(max_digits=40, decimal_places=3, null=True,blank=True, verbose_name="Количество")
    price = models.DecimalField(max_digits=40, decimal_places=3, null=True,blank=True, verbose_name="Цена")
    sum = models.DecimalField(max_digits=40, decimal_places=3, null=True,blank=True, verbose_name="Сумма")
