"""
Django settings for maek_measuring project.
...
SECRET_KEY = 'django-insecure-i-msjgj%l0lfu5&s21gurc)6u)qi8prt@9excx6yf@0)j&^ev5'
...
ROOT_URLCONF = 'maek_measuring.urls'
...
WSGI_APPLICATION = 'maek_measuring.wsgi.application'
